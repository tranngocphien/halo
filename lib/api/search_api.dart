...
Future<List<Map<String, dynamic>>> fetchChatsMessages(searchValue) async {
  // Danh sách các index trong các Chat
  final List<Chat> chatList = SearchData.cached_chat;

  return parseMessage(chatList, searchValue);
}
...
Future<List<dynamic>> fetchSearchData(searchValue) async {
  ...
  parsed_result.add(parseGroupChats(result, searchValue));

  return parsed_result;
}

List<User> parseFriends(final respond, searchValue) {
